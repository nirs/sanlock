...
int delta_lease_acquire(struct sync_disk *disk, uint64_t host_id, uint64_t *timestamp);
int delta_lease_renew(struct sync_disk *disk, uint64_t host_id, uint64_t *timestamp);
